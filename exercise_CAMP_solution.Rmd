...
This file demonstrates a solution for the exercise_CAMP learning module. The goal is to replicate parts of Table 1 and Figure 1 from the following publication, using the associated, publicly available data set.  
